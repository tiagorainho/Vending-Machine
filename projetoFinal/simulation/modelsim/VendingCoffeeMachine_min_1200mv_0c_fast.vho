...
SIGNAL \data|Selector17~1clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \key2|s_debounceCnt[9]~0_combout\ : std_logic;
...
SIGNAL \key2|s_debounceCnt[9]~2_combout\ : std_logic;
SIGNAL \key2|s_debounceCnt[9]~3_combout\ : std_logic;
...
SIGNAL \key2|s_debounceCnt[9]~4_combout\ : std_logic;
...
SIGNAL \key0|s_debounceCnt[13]~0_combout\ : std_logic;
...
SIGNAL \key0|s_debounceCnt[13]~2_combout\ : std_logic;
SIGNAL \key0|s_debounceCnt[13]~3_combout\ : std_logic;
...
SIGNAL \key0|s_debounceCnt[13]~4_combout\ : std_logic;
...
SIGNAL \key1|s_debounceCnt[15]~0_combout\ : std_logic;
...
SIGNAL \key1|s_debounceCnt[15]~2_combout\ : std_logic;
SIGNAL \key1|s_debounceCnt[15]~3_combout\ : std_logic;
...
SIGNAL \key1|s_debounceCnt[15]~4_combout\ : std_logic;
...
SIGNAL \data|NS.F_N_485~combout\ : std_logic;
...
SIGNAL \data|NS.I_541~combout\ : std_logic;
SIGNAL \data|PS.I~0_combout\ : std_logic;
SIGNAL \data|PS.I~q\ : std_logic;
SIGNAL \data|Selector22~0_combout\ : std_logic;
SIGNAL \data|NS.SB_527~combout\ : std_logic;
...
SIGNAL \data|NS.E_513~combout\ : std_logic;
SIGNAL \data|PS.E~q\ : std_logic;
SIGNAL \data|Selector17~0_combout\ : std_logic;
SIGNAL \data|Selector17~1_combout\ : std_logic;
SIGNAL \data|Selector17~1clkctrl_outclk\ : std_logic;
SIGNAL \data|NS.S_499~combout\ : std_logic;
SIGNAL \data|PS.S~q\ : std_logic;
SIGNAL \data|Selector16~0_combout\ : std_logic;
SIGNAL \data|NS.F_T_471~combout\ : std_logic;
...
SIGNAL \data|Selector5~1_combout\ : std_logic;
SIGNAL \data|Selector5~2_combout\ : std_logic;
...
SIGNAL \data|s_money[4]~1_combout\ : std_logic;
SIGNAL \data|Add3~7\ : std_logic;
SIGNAL \data|Add3~8_combout\ : std_logic;
SIGNAL \data|s_money[4]~2_combout\ : std_logic;
...
SIGNAL \data|Selector3~1_combout\ : std_logic;
SIGNAL \data|Selector3~2_combout\ : std_logic;
...
\data|Selector17~1clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \data|Selector17~1_combout\);
...
-- Equation(s):
-- \data|Add1~0_combout\ = \SW[1]~input_o\ $ (\SW[2]~input_o\ $ (\SW[3]~input_o\ $ (\SW[0]~input_o\)))
...
-- Equation(s):
-- \key3|s_debounceCnt~21_combout\ = (\key3|s_debounceCnt[5]~4_combout\ & \key3|Add0~4_combout\)
...
-- Equation(s):
-- \key3|s_pulsedOut~5_combout\ = (!\key3|s_debounceCnt\(2) & (!\key3|s_debounceCnt\(3) & (!\key3|s_debounceCnt\(4) & !\key3|s_debounceCnt\(1))))
...
-- Equation(s):
-- \key3|s_debounceCnt~12_combout\ = (\key3|s_debounceCnt[5]~4_combout\ & \key3|Add0~14_combout\)
...
-- Equation(s):
-- \key3|s_debounceCnt~15_combout\ = (\key3|s_debounceCnt[5]~4_combout\ & \key3|Add0~20_combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \key3|s_debounceCnt[5]~4_combout\,
...
-- Equation(s):
-- \key3|s_debounceCnt~10_combout\ = (\key3|s_debounceCnt[5]~4_combout\ & \key3|Add0~24_combout\)
...
-- Equation(s):
-- \key3|s_debounceCnt~6_combout\ = (\key3|s_debounceCnt[5]~4_combout\ & \key3|Add0~32_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \key3|s_debounceCnt[5]~3_combout\,
	datab => \key3|s_previousIn~q\,
	datac => \key3|s_debounceCnt[5]~0_combout\,
...
-- Equation(s):
-- \key3|s_debounceCnt[19]~19_combout\ = (\key3|s_debounceCnt[5]~0_combout\ & (\key3|s_debounceCnt[5]~3_combout\ & ((\key3|Add0~38_combout\) # (!\key3|s_previousIn~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \key3|s_debounceCnt[5]~0_combout\,
	datab => \key3|s_previousIn~q\,
	datac => \key3|Add0~38_combout\,
	datad => \key3|s_debounceCnt[5]~3_combout\,
...
-- Equation(s):
-- \key3|s_pulsedOut~3_combout\ = (!\key3|s_debounceCnt\(11) & (!\key3|s_debounceCnt\(18) & (!\key3|s_debounceCnt\(19) & !\key3|s_debounceCnt\(14))))
...
-- Equation(s):
-- \key3|s_pulsedOut~2_combout\ = (!\key3|s_debounceCnt\(8) & (!\key3|s_debounceCnt\(9) & (!\key3|s_debounceCnt\(7) & !\key3|s_debounceCnt\(10))))
...
-- Equation(s):
-- \key3|s_debounceCnt[20]~8_combout\ = (\key3|s_debounceCnt[5]~3_combout\ & (\key3|Add0~40_combout\ & \key3|s_debounceCnt[5]~4_combout\))
...
-- Equation(s):
-- \key3|s_pulsedOut~1_combout\ = (!\key3|s_debounceCnt\(21) & (!\key3|s_debounceCnt\(13) & (!\key3|s_debounceCnt\(12) & !\key3|s_debounceCnt\(20))))
...
-- Equation(s):
-- \key3|s_pulsedOut~0_combout\ = (!\key3|s_debounceCnt\(6) & (!\key3|s_debounceCnt\(16) & (!\key3|s_debounceCnt\(15) & !\key3|s_debounceCnt\(17))))
...
-- Equation(s):
-- \key3|s_pulsedOut~4_combout\ = (\key3|s_pulsedOut~3_combout\ & (\key3|s_pulsedOut~2_combout\ & (\key3|s_pulsedOut~1_combout\ & \key3|s_pulsedOut~0_combout\)))
...
PORT MAP (
	...
	datac => \key3|s_pulsedOut~1_combout\,
...
-- Equation(s):
-- \key3|s_debounceCnt[21]~9_combout\ = (\key3|s_debounceCnt[5]~3_combout\ & (\key3|Add0~42_combout\ & \key3|s_debounceCnt[5]~4_combout\))
...
-- Equation(s):
-- \key3|LessThan0~0_combout\ = (\key3|s_debounceCnt\(6) & ((\key3|s_debounceCnt\(0)) # ((\key3|s_debounceCnt\(5)) # (!\key3|s_pulsedOut~5_combout\))))
...
-- Equation(s):
-- \key3|s_debounceCnt~27_combout\ = (\key3|s_debounceCnt[5]~4_combout\ & \key3|Add0~10_combout\)
...
-- Equation(s):
-- \key3|s_pulsedOut~6_combout\ = (\key3|s_dirtyIn~q\ & (\key3|s_previousIn~q\ & (\key3|s_debounceCnt\(0) & !\key3|s_debounceCnt\(22))))
...
-- Equation(s):
-- \key3|s_pulsedOut~7_combout\ = (!\key3|s_debounceCnt\(5) & (\key3|s_pulsedOut~6_combout\ & (\key3|s_pulsedOut~5_combout\ & \key3|s_pulsedOut~4_combout\)))
...
-- Equation(s):
-- \key2|s_debounceCnt~21_combout\ = (\key2|Add0~4_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
PORT MAP (
	...
	datad => \key2|s_debounceCnt[9]~4_combout\,
...
PORT MAP (
	...
	ena => \key2|s_debounceCnt[9]~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \key2|s_debounceCnt~22_combout\ = (\key2|Add0~6_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~23_combout\ = (\key2|Add0~8_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~27_combout\ = (\key2|Add0~10_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~5_combout\ = (\key2|Add0~30_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \key2|Add0~30_combout\,
	datac => \key2|s_debounceCnt[9]~4_combout\,
...
-- Equation(s):
-- \key2|s_debounceCnt~6_combout\ = (\key2|Add0~32_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~7_combout\ = (\key2|Add0~34_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt[18]~18_combout\ = (\key2|s_debounceCnt[9]~3_combout\ & (\key2|s_debounceCnt[9]~0_combout\ & ((\key2|Add0~36_combout\) # (!\key2|s_previousIn~q\))))
...
PORT MAP (
	...
	datac => \key2|s_debounceCnt[9]~3_combout\,
	datad => \key2|s_debounceCnt[9]~0_combout\,
...
-- Equation(s):
-- \key2|s_debounceCnt[19]~19_combout\ = (\key2|s_debounceCnt[9]~3_combout\ & (\key2|s_debounceCnt[9]~0_combout\ & ((\key2|Add0~38_combout\) # (!\key2|s_previousIn~q\))))
...
PORT MAP (
	...
	datab => \key2|s_debounceCnt[9]~3_combout\,
...
-- Equation(s):
-- \key2|s_debounceCnt[20]~8_combout\ = (\key2|s_debounceCnt[9]~4_combout\ & (\key2|s_debounceCnt[9]~3_combout\ & \key2|Add0~40_combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \key2|s_debounceCnt[9]~4_combout\,
	datac => \key2|s_debounceCnt[9]~3_combout\,
...
-- Equation(s):
-- \key2|LessThan0~4_combout\ = (\key2|s_debounceCnt\(15)) # ((\key2|s_debounceCnt\(17)) # (\key2|s_debounceCnt\(16)))
...
-- Equation(s):
-- \key2|LessThan0~0_combout\ = (\key2|s_debounceCnt\(6) & ((\key2|s_debounceCnt\(0)) # ((\key2|s_debounceCnt\(5)) # (!\key2|s_pulsedOut~5_combout\))))
...
-- Equation(s):
-- \key2|LessThan0~3_combout\ = (\key2|s_debounceCnt\(14) & ((\key2|s_debounceCnt\(12)) # ((\key2|s_debounceCnt\(13)) # (\key2|LessThan0~2_combout\))))
...
\key2|s_debounceCnt[9]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \key2|s_debounceCnt[9]~0_combout\ = (\key2|s_dirtyIn~q\ & ((!\key2|LessThan0~6_combout\) # (!\key2|s_debounceCnt\(22))))
...
PORT MAP (
	...
	combout => \key2|s_debounceCnt[9]~0_combout\);

-- Location: LCCOMB_X62_Y31_N8
\key2|s_debounceCnt~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \key2|s_debounceCnt~1_combout\ = (\key2|s_debounceCnt[9]~0_combout\ & ((\key2|Add0~12_combout\) # (!\key2|s_previousIn~q\)))
...
-- Equation(s):
-- \key2|s_debounceCnt~12_combout\ = (\key2|Add0~14_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~13_combout\ = (\key2|s_debounceCnt[9]~0_combout\ & ((\key2|Add0~16_combout\) # (!\key2|s_previousIn~q\)))
...
-- Equation(s):
-- \key2|s_debounceCnt~14_combout\ = (\key2|s_debounceCnt[9]~0_combout\ & ((\key2|Add0~18_combout\) # (!\key2|s_previousIn~q\)))
...
-- Equation(s):
-- \key2|s_debounceCnt~15_combout\ = (\key2|Add0~20_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~16_combout\ = (\key2|s_debounceCnt[9]~0_combout\ & ((\key2|Add0~22_combout\) # (!\key2|s_previousIn~q\)))
...
-- Equation(s):
-- \key2|s_debounceCnt~10_combout\ = (\key2|Add0~24_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~11_combout\ = (\key2|Add0~26_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~17_combout\ = (\key2|s_debounceCnt[9]~0_combout\ & ((\key2|Add0~28_combout\) # (!\key2|s_previousIn~q\)))
...
-- Equation(s):
-- \key2|s_pulsedOut~3_combout\ = (!\key2|s_debounceCnt\(14) & (!\key2|s_debounceCnt\(18) & (!\key2|s_debounceCnt\(19) & !\key2|s_debounceCnt\(11))))
...
-- Equation(s):
-- \key2|s_pulsedOut~2_combout\ = (!\key2|s_debounceCnt\(10) & (!\key2|s_debounceCnt\(7) & (!\key2|s_debounceCnt\(9) & !\key2|s_debounceCnt\(8))))
...
-- Equation(s):
-- \key2|s_pulsedOut~0_combout\ = (!\key2|s_debounceCnt\(17) & (!\key2|s_debounceCnt\(15) & (!\key2|s_debounceCnt\(6) & !\key2|s_debounceCnt\(16))))
...
-- Equation(s):
-- \key2|s_pulsedOut~1_combout\ = (!\key2|s_debounceCnt\(21) & (!\key2|s_debounceCnt\(12) & (!\key2|s_debounceCnt\(13) & !\key2|s_debounceCnt\(20))))
...
-- Equation(s):
-- \key2|s_pulsedOut~4_combout\ = (\key2|s_pulsedOut~3_combout\ & (\key2|s_pulsedOut~2_combout\ & (\key2|s_pulsedOut~0_combout\ & \key2|s_pulsedOut~1_combout\)))
...
PORT MAP (
	...
	datac => \key2|s_pulsedOut~0_combout\,
	datad => \key2|s_pulsedOut~1_combout\,
	combout => \key2|s_pulsedOut~4_combout\);

-- Location: LCCOMB_X62_Y31_N2
\key2|s_debounceCnt[9]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \key2|s_debounceCnt[9]~2_combout\ = (\key2|s_debounceCnt\(0)) # (((\key2|s_debounceCnt\(5)) # (!\key2|s_pulsedOut~4_combout\)) # (!\key2|s_pulsedOut~5_combout\))
...
PORT MAP (
	...
	combout => \key2|s_debounceCnt[9]~2_combout\);

-- Location: LCCOMB_X63_Y31_N8
\key2|s_debounceCnt[9]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \key2|s_debounceCnt[9]~3_combout\ = (\key2|s_debounceCnt\(22)) # (((\key2|s_debounceCnt[9]~2_combout\) # (!\key2|s_previousIn~q\)) # (!\key2|s_dirtyIn~q\))
...
PORT MAP (
	...
	datac => \key2|s_previousIn~q\,
	datad => \key2|s_debounceCnt[9]~2_combout\,
	combout => \key2|s_debounceCnt[9]~3_combout\);
...
-- Equation(s):
-- \key2|s_debounceCnt[21]~9_combout\ = (\key2|s_debounceCnt[9]~4_combout\ & (\key2|s_debounceCnt[9]~3_combout\ & \key2|Add0~42_combout\))
...
-- Equation(s):
-- \key2|s_debounceCnt[22]~25_combout\ = (\key2|s_debounceCnt\(22) & (((!\key2|LessThan0~6_combout\)))) # (!\key2|s_debounceCnt\(22) & (((\key2|s_debounceCnt[9]~2_combout\)) # (!\key2|s_previousIn~q\)))
...
PORT MAP (
	dataa => \key2|s_previousIn~q\,
	datab => \key2|s_debounceCnt\(22),
	datac => \key2|s_debounceCnt[9]~2_combout\,
	datad => \key2|LessThan0~6_combout\,
...
\key2|s_debounceCnt[9]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \key2|s_debounceCnt[9]~4_combout\ = (\key2|s_dirtyIn~q\ & (\key2|s_previousIn~q\ & ((!\key2|LessThan0~6_combout\) # (!\key2|s_debounceCnt\(22)))))
...
PORT MAP (
	...
	datac => \key2|s_previousIn~q\,
	datad => \key2|LessThan0~6_combout\,
	combout => \key2|s_debounceCnt[9]~4_combout\);

-- Location: LCCOMB_X62_Y31_N12
\key2|s_debounceCnt~24\ : cycloneive_lcell_comb
-- Equation(s):
-- \key2|s_debounceCnt~24_combout\ = (\key2|Add0~0_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_debounceCnt~20_combout\ = (\key2|Add0~2_combout\ & \key2|s_debounceCnt[9]~4_combout\)
...
-- Equation(s):
-- \key2|s_pulsedOut~5_combout\ = (!\key2|s_debounceCnt\(1) & (!\key2|s_debounceCnt\(3) & (!\key2|s_debounceCnt\(4) & !\key2|s_debounceCnt\(2))))
...
-- Equation(s):
-- \key2|s_pulsedOut~6_combout\ = (\key2|s_debounceCnt\(0) & (\key2|s_previousIn~q\ & (\key2|s_dirtyIn~q\ & !\key2|s_debounceCnt\(22))))
...
-- Equation(s):
-- \key0|s_debounceCnt~23_combout\ = (\key0|Add0~8_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
PORT MAP (
	...
	datad => \key0|s_debounceCnt[13]~4_combout\,
...
PORT MAP (
	...
	ena => \key0|s_debounceCnt[13]~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \key0|s_debounceCnt~27_combout\ = (\key0|Add0~10_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
\key0|s_debounceCnt[13]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \key0|s_debounceCnt[13]~0_combout\ = (\key0|s_dirtyIn~q\ & ((!\key0|LessThan0~6_combout\) # (!\key0|s_debounceCnt\(22))))
...
PORT MAP (
	...
	combout => \key0|s_debounceCnt[13]~0_combout\);
...
-- Equation(s):
-- \key0|s_debounceCnt~1_combout\ = (\key0|s_debounceCnt[13]~0_combout\ & ((\key0|Add0~12_combout\) # (!\key0|s_previousIn~q\)))
...
PORT MAP (
	...
	datac => \key0|s_debounceCnt[13]~0_combout\,
...
-- Equation(s):
-- \key0|s_debounceCnt~12_combout\ = (\key0|Add0~14_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~13_combout\ = (\key0|s_debounceCnt[13]~0_combout\ & ((\key0|Add0~16_combout\) # (!\key0|s_previousIn~q\)))
...
-- Equation(s):
-- \key0|s_debounceCnt~14_combout\ = (\key0|s_debounceCnt[13]~0_combout\ & ((\key0|Add0~18_combout\) # (!\key0|s_previousIn~q\)))
...
-- Equation(s):
-- \key0|s_debounceCnt~15_combout\ = (\key0|Add0~20_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~16_combout\ = (\key0|s_debounceCnt[13]~0_combout\ & ((\key0|Add0~22_combout\) # (!\key0|s_previousIn~q\)))
...
-- Equation(s):
-- \key0|s_debounceCnt~10_combout\ = (\key0|Add0~24_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~11_combout\ = (\key0|Add0~26_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~17_combout\ = (\key0|s_debounceCnt[13]~0_combout\ & ((\key0|Add0~28_combout\) # (!\key0|s_previousIn~q\)))
...
-- Equation(s):
-- \key0|s_debounceCnt~5_combout\ = (\key0|Add0~30_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~6_combout\ = (\key0|Add0~32_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~7_combout\ = (\key0|Add0~34_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt[18]~18_combout\ = (\key0|s_debounceCnt[13]~3_combout\ & (\key0|s_debounceCnt[13]~0_combout\ & ((\key0|Add0~36_combout\) # (!\key0|s_previousIn~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \key0|s_debounceCnt[13]~3_combout\,
	datab => \key0|s_previousIn~q\,
	datac => \key0|s_debounceCnt[13]~0_combout\,
...
-- Equation(s):
-- \key0|s_debounceCnt[19]~19_combout\ = (\key0|s_debounceCnt[13]~3_combout\ & (\key0|s_debounceCnt[13]~0_combout\ & ((\key0|Add0~38_combout\) # (!\key0|s_previousIn~q\))))
...
-- Equation(s):
-- \key0|s_debounceCnt[20]~8_combout\ = (\key0|s_debounceCnt[13]~3_combout\ & (\key0|Add0~40_combout\ & \key0|s_debounceCnt[13]~4_combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \key0|s_debounceCnt[13]~3_combout\,
...
-- Equation(s):
-- \key0|s_pulsedOut~1_combout\ = (!\key0|s_debounceCnt\(12) & (!\key0|s_debounceCnt\(20) & (!\key0|s_debounceCnt\(21) & !\key0|s_debounceCnt\(13))))
...
-- Equation(s):
-- \key0|s_pulsedOut~0_combout\ = (!\key0|s_debounceCnt\(6) & (!\key0|s_debounceCnt\(15) & (!\key0|s_debounceCnt\(16) & !\key0|s_debounceCnt\(17))))
...
-- Equation(s):
-- \key0|s_pulsedOut~2_combout\ = (!\key0|s_debounceCnt\(8) & (!\key0|s_debounceCnt\(10) & (!\key0|s_debounceCnt\(9) & !\key0|s_debounceCnt\(7))))
...
-- Equation(s):
-- \key0|s_pulsedOut~4_combout\ = (\key0|s_pulsedOut~3_combout\ & (\key0|s_pulsedOut~1_combout\ & (\key0|s_pulsedOut~0_combout\ & \key0|s_pulsedOut~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \key0|s_pulsedOut~3_combout\,
	datab => \key0|s_pulsedOut~1_combout\,
...
\key0|s_debounceCnt[13]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \key0|s_debounceCnt[13]~2_combout\ = (\key0|s_debounceCnt\(5)) # ((\key0|s_debounceCnt\(0)) # ((!\key0|s_pulsedOut~4_combout\) # (!\key0|s_pulsedOut~5_combout\)))
...
PORT MAP (
	...
	combout => \key0|s_debounceCnt[13]~2_combout\);

-- Location: LCCOMB_X90_Y37_N10
\key0|s_debounceCnt[13]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \key0|s_debounceCnt[13]~3_combout\ = (((\key0|s_debounceCnt\(22)) # (\key0|s_debounceCnt[13]~2_combout\)) # (!\key0|s_previousIn~q\)) # (!\key0|s_dirtyIn~q\)
...
PORT MAP (
	...
	datab => \key0|s_previousIn~q\,
	datac => \key0|s_debounceCnt\(22),
	datad => \key0|s_debounceCnt[13]~2_combout\,
	combout => \key0|s_debounceCnt[13]~3_combout\);
...
-- Equation(s):
-- \key0|s_debounceCnt[21]~9_combout\ = (\key0|s_debounceCnt[13]~3_combout\ & (\key0|Add0~42_combout\ & \key0|s_debounceCnt[13]~4_combout\))
...
-- Equation(s):
-- \key0|LessThan0~4_combout\ = (\key0|s_debounceCnt\(16)) # ((\key0|s_debounceCnt\(17)) # (\key0|s_debounceCnt\(15)))
...
-- Equation(s):
-- \key0|s_debounceCnt[22]~25_combout\ = (\key0|s_previousIn~q\ & (((!\key0|s_debounceCnt[13]~2_combout\ & !\key0|s_debounceCnt\(22))) # (!\key0|Add0~44_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \key0|s_debounceCnt[13]~2_combout\,
	datab => \key0|s_previousIn~q\,
	datac => \key0|s_debounceCnt\(22),
...
-- Equation(s):
-- \key0|s_debounceCnt[22]~26_combout\ = (\key0|s_dirtyIn~q\ & (!\key0|s_debounceCnt[22]~25_combout\ & ((!\key0|s_debounceCnt\(22)) # (!\key0|LessThan0~6_combout\))))
...
PORT MAP (
	dataa => \key0|s_dirtyIn~q\,
	datab => \key0|LessThan0~6_combout\,
	datac => \key0|s_debounceCnt\(22),
...
\key0|s_debounceCnt[13]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \key0|s_debounceCnt[13]~4_combout\ = (\key0|s_dirtyIn~q\ & (\key0|s_previousIn~q\ & ((!\key0|LessThan0~6_combout\) # (!\key0|s_debounceCnt\(22)))))
...
PORT MAP (
	...
	datac => \key0|s_debounceCnt\(22),
	datad => \key0|LessThan0~6_combout\,
	combout => \key0|s_debounceCnt[13]~4_combout\);

-- Location: LCCOMB_X90_Y37_N28
\key0|s_debounceCnt~24\ : cycloneive_lcell_comb
-- Equation(s):
-- \key0|s_debounceCnt~24_combout\ = (\key0|Add0~0_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~20_combout\ = (\key0|Add0~2_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~21_combout\ = (\key0|Add0~4_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_debounceCnt~22_combout\ = (\key0|Add0~6_combout\ & \key0|s_debounceCnt[13]~4_combout\)
...
-- Equation(s):
-- \key0|s_pulsedOut~5_combout\ = (!\key0|s_debounceCnt\(3) & (!\key0|s_debounceCnt\(1) & (!\key0|s_debounceCnt\(4) & !\key0|s_debounceCnt\(2))))
...
-- Equation(s):
-- \key0|s_pulsedOut~6_combout\ = (\key0|s_debounceCnt\(0) & (\key0|s_previousIn~q\ & (\key0|s_dirtyIn~q\ & !\key0|s_debounceCnt\(22))))
...
-- Equation(s):
-- \key0|s_pulsedOut~7_combout\ = (\key0|s_pulsedOut~5_combout\ & (\key0|s_pulsedOut~6_combout\ & (!\key0|s_debounceCnt\(5) & \key0|s_pulsedOut~4_combout\)))
...
PORT MAP (
	clk => \CLOCK_50~input_o\,
	asdata => \key0|s_pulsedOut~7_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \key1|s_pulsedOut~5_combout\ = (!\key1|s_debounceCnt\(1) & (!\key1|s_debounceCnt\(4) & (!\key1|s_debounceCnt\(3) & !\key1|s_debounceCnt\(2))))
...
\key1|s_debounceCnt[15]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \key1|s_debounceCnt[15]~0_combout\ = (\key1|s_dirtyIn~q\ & ((!\key1|LessThan0~6_combout\) # (!\key1|s_debounceCnt\(22))))
...
PORT MAP (
	...
	combout => \key1|s_debounceCnt[15]~0_combout\);

-- Location: LCCOMB_X102_Y34_N8
\key1|s_debounceCnt~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \key1|s_debounceCnt~1_combout\ = (\key1|s_debounceCnt[15]~0_combout\ & ((\key1|Add0~12_combout\) # (!\key1|s_previousIn~q\)))
...
-- pragma translate_on
PORT MAP (
	datab => \key1|Add0~12_combout\,
	datac => \key1|s_previousIn~q\,
	datad => \key1|s_debounceCnt[15]~0_combout\,
...
PORT MAP (
	...
	ena => \key1|s_debounceCnt[15]~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \key1|s_debounceCnt~12_combout\ = (\key1|s_debounceCnt[15]~4_combout\ & \key1|Add0~14_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \key1|s_debounceCnt[15]~4_combout\,
...
-- Equation(s):
-- \key1|s_debounceCnt~13_combout\ = (\key1|s_debounceCnt[15]~0_combout\ & ((\key1|Add0~16_combout\) # (!\key1|s_previousIn~q\)))
...
-- Equation(s):
-- \key1|s_debounceCnt~14_combout\ = (\key1|s_debounceCnt[15]~0_combout\ & ((\key1|Add0~18_combout\) # (!\key1|s_previousIn~q\)))
...
-- Equation(s):
-- \key1|s_debounceCnt~15_combout\ = (\key1|s_debounceCnt[15]~4_combout\ & \key1|Add0~20_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~16_combout\ = (\key1|s_debounceCnt[15]~0_combout\ & ((\key1|Add0~22_combout\) # (!\key1|s_previousIn~q\)))
...
-- Equation(s):
-- \key1|s_debounceCnt~10_combout\ = (\key1|s_debounceCnt[15]~4_combout\ & \key1|Add0~24_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~11_combout\ = (\key1|Add0~26_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
PORT MAP (
	...
	datad => \key1|s_debounceCnt[15]~4_combout\,
...
-- Equation(s):
-- \key1|s_debounceCnt~17_combout\ = (\key1|s_debounceCnt[15]~0_combout\ & ((\key1|Add0~28_combout\) # (!\key1|s_previousIn~q\)))
...
-- Equation(s):
-- \key1|s_debounceCnt~5_combout\ = (\key1|Add0~30_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~6_combout\ = (\key1|s_debounceCnt[15]~4_combout\ & \key1|Add0~32_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~7_combout\ = (\key1|Add0~34_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt[18]~18_combout\ = (\key1|s_debounceCnt[15]~3_combout\ & (\key1|s_debounceCnt[15]~0_combout\ & ((\key1|Add0~36_combout\) # (!\key1|s_previousIn~q\))))
...
PORT MAP (
	...
	datab => \key1|s_debounceCnt[15]~3_combout\,
	datac => \key1|s_previousIn~q\,
	datad => \key1|s_debounceCnt[15]~0_combout\,
...
-- Equation(s):
-- \key1|s_pulsedOut~3_combout\ = (!\key1|s_debounceCnt\(14) & (!\key1|s_debounceCnt\(18) & (!\key1|s_debounceCnt\(19) & !\key1|s_debounceCnt\(11))))
...
-- Equation(s):
-- \key1|s_pulsedOut~0_combout\ = (!\key1|s_debounceCnt\(16) & (!\key1|s_debounceCnt\(6) & (!\key1|s_debounceCnt\(17) & !\key1|s_debounceCnt\(15))))
...
-- Equation(s):
-- \key1|s_pulsedOut~1_combout\ = (!\key1|s_debounceCnt\(20) & (!\key1|s_debounceCnt\(12) & (!\key1|s_debounceCnt\(21) & !\key1|s_debounceCnt\(13))))
...
-- Equation(s):
-- \key1|s_pulsedOut~2_combout\ = (!\key1|s_debounceCnt\(7) & (!\key1|s_debounceCnt\(8) & (!\key1|s_debounceCnt\(10) & !\key1|s_debounceCnt\(9))))
...
-- Equation(s):
-- \key1|s_pulsedOut~4_combout\ = (\key1|s_pulsedOut~3_combout\ & (\key1|s_pulsedOut~0_combout\ & (\key1|s_pulsedOut~1_combout\ & \key1|s_pulsedOut~2_combout\)))
...
PORT MAP (
	...
	datac => \key1|s_pulsedOut~1_combout\,
	datad => \key1|s_pulsedOut~2_combout\,
	combout => \key1|s_pulsedOut~4_combout\);

-- Location: LCCOMB_X102_Y34_N28
\key1|s_debounceCnt[15]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \key1|s_debounceCnt[15]~2_combout\ = (\key1|s_debounceCnt\(5)) # (((\key1|s_debounceCnt\(0)) # (!\key1|s_pulsedOut~4_combout\)) # (!\key1|s_pulsedOut~5_combout\))
...
PORT MAP (
	...
	combout => \key1|s_debounceCnt[15]~2_combout\);

-- Location: LCCOMB_X102_Y34_N18
\key1|s_debounceCnt[15]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \key1|s_debounceCnt[15]~3_combout\ = (((\key1|s_debounceCnt\(22)) # (\key1|s_debounceCnt[15]~2_combout\)) # (!\key1|s_dirtyIn~q\)) # (!\key1|s_previousIn~q\)
...
PORT MAP (
	...
	datad => \key1|s_debounceCnt[15]~2_combout\,
	combout => \key1|s_debounceCnt[15]~3_combout\);
...
-- Equation(s):
-- \key1|s_debounceCnt[19]~19_combout\ = (\key1|s_debounceCnt[15]~3_combout\ & (\key1|s_debounceCnt[15]~0_combout\ & ((\key1|Add0~38_combout\) # (!\key1|s_previousIn~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \key1|s_debounceCnt[15]~3_combout\,
...
-- Equation(s):
-- \key1|s_debounceCnt[20]~8_combout\ = (\key1|s_debounceCnt[15]~4_combout\ & (\key1|Add0~40_combout\ & \key1|s_debounceCnt[15]~3_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \key1|s_debounceCnt[15]~4_combout\,
	datac => \key1|Add0~40_combout\,
	datad => \key1|s_debounceCnt[15]~3_combout\,
...
-- Equation(s):
-- \key1|s_debounceCnt[21]~9_combout\ = (\key1|s_debounceCnt[15]~4_combout\ & (\key1|Add0~42_combout\ & \key1|s_debounceCnt[15]~3_combout\))
...
-- Equation(s):
-- \key1|LessThan0~4_combout\ = (\key1|s_debounceCnt\(17)) # ((\key1|s_debounceCnt\(16)) # (\key1|s_debounceCnt\(15)))
...
-- Equation(s):
-- \key1|s_debounceCnt[22]~25_combout\ = (\key1|s_previousIn~q\ & (((!\key1|s_debounceCnt\(22) & !\key1|s_debounceCnt[15]~2_combout\)) # (!\key1|Add0~44_combout\)))
...
\key1|s_debounceCnt[15]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \key1|s_debounceCnt[15]~4_combout\ = (\key1|s_dirtyIn~q\ & (\key1|s_previousIn~q\ & ((!\key1|LessThan0~6_combout\) # (!\key1|s_debounceCnt\(22)))))
...
PORT MAP (
	...
	datac => \key1|s_previousIn~q\,
	datad => \key1|LessThan0~6_combout\,
	combout => \key1|s_debounceCnt[15]~4_combout\);

-- Location: LCCOMB_X102_Y34_N4
\key1|s_debounceCnt~24\ : cycloneive_lcell_comb
-- Equation(s):
-- \key1|s_debounceCnt~24_combout\ = (\key1|Add0~0_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~20_combout\ = (\key1|Add0~2_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~21_combout\ = (\key1|Add0~4_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~22_combout\ = (\key1|Add0~6_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~23_combout\ = (\key1|Add0~8_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_debounceCnt~27_combout\ = (\key1|Add0~10_combout\ & \key1|s_debounceCnt[15]~4_combout\)
...
-- Equation(s):
-- \key1|s_pulsedOut~6_combout\ = (\key1|s_dirtyIn~q\ & (\key1|s_debounceCnt\(0) & (!\key1|s_debounceCnt\(22) & \key1|s_previousIn~q\)))
...
-- Equation(s):
-- \data|comb_proc~1_combout\ = (\key3|s_pulsedOut~q\) # ((\key2|s_pulsedOut~q\) # ((\key0|s_pulsedOut~q\) # (\key1|s_pulsedOut~q\)))
...
-- Equation(s):
-- \data|Add1~1_combout\ = (\SW[1]~input_o\ & ((\SW[2]~input_o\ & ((!\SW[0]~input_o\) # (!\SW[3]~input_o\))) # (!\SW[2]~input_o\ & ((\SW[3]~input_o\) # (\SW[0]~input_o\))))) # (!\SW[1]~input_o\ & ((\SW[2]~input_o\ & ((\SW[3]~input_o\) # (\SW[0]~input_o\))) # 
-- (!\SW[2]~input_o\ & (\SW[3]~input_o\ & \SW[0]~input_o\))))
...
-- Equation(s):
-- \data|Add1~2_combout\ = (\SW[1]~input_o\ & (\SW[2]~input_o\ & (\SW[3]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \data|Selector18~0_combout\ = (\data|PS.S~q\ & ((\data|s_count_switches\(1)) # ((\data|s_count_switches\(2)) # (\data|s_count_switches\(0)))))
...
\data|NS.F_N_485\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|NS.F_N_485~combout\ = (GLOBAL(\data|Selector17~1clkctrl_outclk\) & ((\data|Selector18~0_combout\))) # (!GLOBAL(\data|Selector17~1clkctrl_outclk\) & (\data|NS.F_N_485~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|NS.F_N_485~combout\,
	datac => \data|Selector18~0_combout\,
	datad => \data|Selector17~1clkctrl_outclk\,
	combout => \data|NS.F_N_485~combout\);
...
-- Equation(s):
-- \data|Equal0~0_combout\ = (!\data|s_count_switches\(1) & !\data|s_count_switches\(2))
...
-- Equation(s):
-- \data|Selector23~0_combout\ = (\data|PS.F_N~q\) # ((\data|PS.E~q\ & (!\data|s_count_switches\(0) & \data|Equal0~0_combout\)))
...
-- Equation(s):
-- \data|Selector23~1_combout\ = (\data|Selector23~0_combout\) # ((\data|WideOr1~0_combout\ & ((!\data|s_count_switches\(0)) # (!\data|Equal0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Equal0~0_combout\,
	datab => \data|s_count_switches\(0),
	datac => \data|WideOr1~0_combout\,
	datad => \data|Selector23~0_combout\,
	combout => \data|Selector23~1_combout\);

-- Location: LCCOMB_X105_Y36_N0
\data|NS.I_541\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|NS.I_541~combout\ = (GLOBAL(\data|Selector21~1clkctrl_outclk\) & (\data|Selector23~1_combout\)) # (!GLOBAL(\data|Selector21~1clkctrl_outclk\) & ((\data|NS.I_541~combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Selector21~1clkctrl_outclk\,
	datac => \data|Selector23~1_combout\,
	datad => \data|NS.I_541~combout\,
	combout => \data|NS.I_541~combout\);

-- Location: LCCOMB_X105_Y36_N12
\data|PS.I~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|PS.I~0_combout\ = !\data|NS.I_541~combout\
...
\data|Selector22~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector22~0_combout\ = (\data|Equal0~0_combout\ & (((!\data|PS.I~q\ & \data|s_count_switches\(0))))) # (!\data|Equal0~0_combout\ & (\data|PS.E~q\))
...
PORT MAP (
	...
	combout => \data|Selector22~0_combout\);

-- Location: LCCOMB_X105_Y36_N14
\data|NS.SB_527\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|NS.SB_527~combout\ = (GLOBAL(\data|Selector21~1clkctrl_outclk\) & ((\data|Selector22~0_combout\))) # (!GLOBAL(\data|Selector21~1clkctrl_outclk\) & (\data|NS.SB_527~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \data|NS.SB_527~combout\,
	datac => \data|Selector21~1clkctrl_outclk\,
	datad => \data|Selector22~0_combout\,
	combout => \data|NS.SB_527~combout\);

-- Location: FF_X105_Y36_N7
\data|PS.SB\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \data|Selector15~0_combout\ = (!\data|s_count_switches\(2) & (\data|PS.SB~q\ & (!\data|s_count_switches\(1) & \data|s_count_switches\(0))))
...
-- Equation(s):
-- \data|Selector21~1_combout\ = (\data|Selector21~0_combout\ & (\data|Selector24~0_combout\ & ((\data|comb_proc~1_combout\) # (!\data|Selector15~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|comb_proc~1_combout\,
	datab => \data|Selector21~0_combout\,
...
-- Equation(s):
-- \data|Selector20~0_combout\ = (!\data|s_count_switches\(1) & (\data|PS.E~q\ & (\data|s_count_switches\(0) & !\data|s_count_switches\(2))))
...
\data|NS.E_513\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|NS.E_513~combout\ = (GLOBAL(\data|Selector21~1clkctrl_outclk\) & ((\data|Selector20~0_combout\))) # (!GLOBAL(\data|Selector21~1clkctrl_outclk\) & (\data|NS.E_513~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|NS.E_513~combout\,
	datac => \data|Selector21~1clkctrl_outclk\,
	datad => \data|Selector20~0_combout\,
	combout => \data|NS.E_513~combout\);
...
-- Equation(s):
-- \data|Selector17~0_combout\ = (\data|PS.SB~q\ & (((\data|comb_proc~1_combout\) # (!\data|Equal0~0_combout\)) # (!\data|s_count_switches\(0))))
...
\data|Selector17~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector17~1_combout\ = (\data|PS.E~q\) # ((\data|Selector17~0_combout\) # (!\data|Selector38~1_combout\))
...
PORT MAP (
	datab => \data|PS.E~q\,
	datac => \data|Selector38~1_combout\,
	datad => \data|Selector17~0_combout\,
	combout => \data|Selector17~1_combout\);

-- Location: CLKCTRL_G6
\data|Selector17~1clkctrl\ : cycloneive_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \data|Selector17~1clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \data|Selector17~1clkctrl_outclk\);

-- Location: LCCOMB_X106_Y36_N14
\data|NS.S_499\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|NS.S_499~combout\ = (GLOBAL(\data|Selector17~1clkctrl_outclk\) & ((\data|Selector15~0_combout\))) # (!GLOBAL(\data|Selector17~1clkctrl_outclk\) & (\data|NS.S_499~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \data|NS.S_499~combout\,
	datac => \data|Selector17~1clkctrl_outclk\,
	datad => \data|Selector15~0_combout\,
	combout => \data|NS.S_499~combout\);
...
-- Equation(s):
-- \data|Selector16~0_combout\ = (!\data|s_count_switches\(2) & (\data|PS.S~q\ & (!\data|s_count_switches\(0) & !\data|s_count_switches\(1))))
...
\data|NS.F_T_471\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|NS.F_T_471~combout\ = (GLOBAL(\data|Selector17~1clkctrl_outclk\) & ((\data|Selector16~0_combout\))) # (!GLOBAL(\data|Selector17~1clkctrl_outclk\) & (\data|NS.F_T_471~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \data|NS.F_T_471~combout\,
	datac => \data|Selector16~0_combout\,
	datad => \data|Selector17~1clkctrl_outclk\,
	combout => \data|NS.F_T_471~combout\);
...
-- Equation(s):
-- \data|Selector34~0_combout\ = (\data|Selector15~0_combout\ & ((\SW[1]~input_o\) # (\SW[0]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	datab => \data|Selector15~0_combout\,
	datac => \SW[1]~input_o\,
	datad => \SW[0]~input_o\,
...
-- Equation(s):
-- \data|s_price\(5) = (\data|WideOr1~0_combout\ & (\data|Selector34~0_combout\)) # (!\data|WideOr1~0_combout\ & ((\data|s_price\(5))))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Selector34~0_combout\,
...
-- Equation(s):
-- \data|Selector31~1_combout\ = ((\data|comb_proc~1_combout\ & (\data|s_count_switches\(0) & \data|Equal0~0_combout\))) # (!\data|PS.SB~q\)
...
-- Equation(s):
-- \data|Selector31~0_combout\ = (!\data|PS.F_N~q\ & !\data|PS.F_T~q\)
...
-- Equation(s):
-- \data|Selector31~2_combout\ = (\data|Selector31~1_combout\ & (!\data|PS.S~q\ & (\data|Selector31~0_combout\ & !\data|PS.E~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Selector31~1_combout\,
	datab => \data|PS.S~q\,
...
-- Equation(s):
-- \data|comb_proc~0_combout\ = (!\key0|s_pulsedOut~q\ & !\key1|s_pulsedOut~q\)
...
-- Equation(s):
-- \data|Selector28~0_combout\ = (\data|Selector31~2_combout\) # ((\key0|s_pulsedOut~q\ & \data|PS.S~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Selector27~0_combout\,
	datac => \data|s_money\(0),
...
PORT MAP (
	...
	datac => \data|Selector29~0_combout\,
...
-- Equation(s):
-- \data|Selector30~0_combout\ = (\key3|s_pulsedOut~q\ & !\key2|s_pulsedOut~q\)
...
PORT MAP (
	...
	datab => \data|Selector31~2_combout\,
	datac => \data|PS.S~q\,
...
PORT MAP (
	dataa => \data|s_money\(1),
	datab => \data|Selector29~1_combout\,
...
-- Equation(s):
-- \data|s_money[2]~0_combout\ = (\key0|s_pulsedOut~q\) # ((\key2|s_pulsedOut~q\ & !\key1|s_pulsedOut~q\))
...
-- Equation(s):
-- \data|s_money[2]~3_combout\ = (\data|comb_proc~0_combout\ & ((\data|s_money[2]~0_combout\ & (\data|Add5~0_combout\)) # (!\data|s_money[2]~0_combout\ & ((\data|Add6~2_combout\))))) # (!\data|comb_proc~0_combout\ & (((\data|s_money[2]~0_combout\))))
...
PORT MAP (
	...
	datac => \data|comb_proc~0_combout\,
...
-- Equation(s):
-- \data|s_money[2]~4_combout\ = (\data|comb_proc~0_combout\ & (((\data|s_money[2]~3_combout\)))) # (!\data|comb_proc~0_combout\ & ((\data|s_money[2]~3_combout\ & (\data|Add3~4_combout\)) # (!\data|s_money[2]~3_combout\ & ((\data|Add4~2_combout\)))))
...
-- Equation(s):
-- \data|Selector6~0_combout\ = (\data|PS.S~q\ & \data|s_money[2]~4_combout\)
...
PORT MAP (
	...
	datad => \data|Selector6~0_combout\,
...
-- Equation(s):
-- \data|Selector5~0_combout\ = (\data|comb_proc~0_combout\ & (((\data|Add6~4_combout\) # (\data|s_money[2]~0_combout\)))) # (!\data|comb_proc~0_combout\ & (\data|Add4~4_combout\ & ((!\data|s_money[2]~0_combout\))))
...
\data|Selector5~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector5~1_combout\ = (\data|PS.S~q\ & ((\data|Add3~6_combout\) # (\data|Selector5~0_combout\)))
...
PORT MAP (
	...
	combout => \data|Selector5~1_combout\);

-- Location: LCCOMB_X106_Y37_N28
\data|Selector5~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector5~2_combout\ = (\data|Selector5~1_combout\ & ((\data|Selector5~0_combout\ & ((\data|Add5~2_combout\) # (!\data|s_money[2]~0_combout\))) # (!\data|Selector5~0_combout\ & (\data|s_money[2]~0_combout\))))
...
PORT MAP (
	...
	datad => \data|Selector5~1_combout\,
	combout => \data|Selector5~2_combout\);

-- Location: LCCOMB_X106_Y37_N24
\data|s_money[3]\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|s_money\(3) = (\data|Selector31~3_combout\ & ((\data|Selector5~2_combout\))) # (!\data|Selector31~3_combout\ & (\data|s_money\(3)))
...
PORT MAP (
	datab => \data|s_money\(3),
	datac => \data|Selector31~3_combout\,
	datad => \data|Selector5~2_combout\,
...
\data|s_money[4]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|s_money[4]~1_combout\ = (\data|comb_proc~0_combout\ & ((\data|s_money[2]~0_combout\ & (\data|Add5~4_combout\)) # (!\data|s_money[2]~0_combout\ & ((\data|Add6~6_combout\))))) # (!\data|comb_proc~0_combout\ & (((\data|s_money[2]~0_combout\))))
...
PORT MAP (
	...
	datac => \data|Add6~6_combout\,
	datad => \data|s_money[2]~0_combout\,
	combout => \data|s_money[4]~1_combout\);
...
\data|s_money[4]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|s_money[4]~2_combout\ = (\data|comb_proc~0_combout\ & (((\data|s_money[4]~1_combout\)))) # (!\data|comb_proc~0_combout\ & ((\data|s_money[4]~1_combout\ & ((\data|Add3~8_combout\))) # (!\data|s_money[4]~1_combout\ & (\data|Add4~6_combout\))))
...
PORT MAP (
	dataa => \data|comb_proc~0_combout\,
	datab => \data|Add4~6_combout\,
	datac => \data|s_money[4]~1_combout\,
	datad => \data|Add3~8_combout\,
	combout => \data|s_money[4]~2_combout\);

-- Location: LCCOMB_X105_Y37_N6
\data|Selector4~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector4~0_combout\ = (\data|PS.S~q\ & \data|s_money[4]~2_combout\)
...
PORT MAP (
	dataa => \data|PS.S~q\,
	datad => \data|s_money[4]~2_combout\,
	combout => \data|Selector4~0_combout\);

-- Location: LCCOMB_X105_Y37_N2
\data|s_money[4]\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|s_money\(4) = (\data|Selector31~3_combout\ & ((\data|Selector4~0_combout\))) # (!\data|Selector31~3_combout\ & (\data|s_money\(4)))
...
-- Equation(s):
-- \data|Selector3~0_combout\ = (\data|PS.S~q\ & ((\data|Add5~6_combout\) # ((!\data|comb_proc~0_combout\) # (!\data|s_money[2]~0_combout\))))
...
\data|Selector3~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector3~1_combout\ = (\data|comb_proc~0_combout\ & (((\data|Add6~8_combout\) # (\data|s_money[2]~0_combout\)))) # (!\data|comb_proc~0_combout\ & (\data|Add4~8_combout\ & ((!\data|s_money[2]~0_combout\))))
...
PORT MAP (
	dataa => \data|comb_proc~0_combout\,
	datab => \data|Add4~8_combout\,
	datac => \data|Add6~8_combout\,
	datad => \data|s_money[2]~0_combout\,
	combout => \data|Selector3~1_combout\);

-- Location: LCCOMB_X106_Y37_N22
\data|Selector3~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector3~2_combout\ = (\data|Selector3~0_combout\ & ((\data|Selector3~1_combout\) # ((\data|Add3~10_combout\ & \data|s_money[2]~0_combout\))))
...
PORT MAP (
	...
	datad => \data|Selector3~1_combout\,
	combout => \data|Selector3~2_combout\);

-- Location: LCCOMB_X106_Y37_N4
\data|s_money[5]\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|s_money\(5) = (\data|Selector31~3_combout\ & ((\data|Selector3~2_combout\))) # (!\data|Selector31~3_combout\ & (\data|s_money\(5)))
...
PORT MAP (
	datab => \data|s_money\(5),
	datac => \data|Selector3~2_combout\,
	datad => \data|Selector31~3_combout\,
	combout => \data|s_money\(5));

-- Location: LCCOMB_X107_Y36_N26
\data|Selector32~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \data|Selector32~0_combout\ = (\data|Selector15~0_combout\ & ((\SW[0]~input_o\) # (!\SW[1]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Selector32~0_combout\,
...
-- Equation(s):
-- \data|Selector33~0_combout\ = (!\SW[0]~input_o\ & \data|Selector15~0_combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \data|Selector33~0_combout\,
...
-- Equation(s):
-- \data|Selector0~0_combout\ = (\data|Selector15~0_combout\ & (\SW[1]~input_o\ & !\SW[0]~input_o\))
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Selector0~0_combout\,
...
-- Equation(s):
-- \data|LessThan1~1_cout\ = CARRY((\data|s_price\(0) & !\data|s_money\(0)))
...
-- Equation(s):
-- \data|LessThan1~5_cout\ = CARRY((\data|s_money\(2) & (\data|s_price\(3) & !\data|LessThan1~3_cout\)) # (!\data|s_money\(2) & ((\data|s_price\(3)) # (!\data|LessThan1~3_cout\))))
...
-- Equation(s):
-- \data|LessThan1~7_cout\ = CARRY((\data|s_money\(3) & ((!\data|LessThan1~5_cout\) # (!\data|s_price\(3)))) # (!\data|s_money\(3) & (!\data|s_price\(3) & !\data|LessThan1~5_cout\)))
...
-- Equation(s):
-- \data|LessThan1~9_cout\ = CARRY((\data|s_money\(4) & (\data|s_price\(4) & !\data|LessThan1~7_cout\)) # (!\data|s_money\(4) & ((\data|s_price\(4)) # (!\data|LessThan1~7_cout\))))
...
-- Equation(s):
-- \data|LessThan1~10_combout\ = (\data|s_price\(5) & ((\data|LessThan1~9_cout\) # (!\data|s_money\(5)))) # (!\data|s_price\(5) & (\data|LessThan1~9_cout\ & !\data|s_money\(5)))
...
-- Equation(s):
-- \data|Add6~10_combout\ = \data|s_money\(6) $ (\data|Add6~9\)
...
-- Equation(s):
-- \data|Selector2~1_combout\ = (\data|s_money[2]~0_combout\ & ((\data|Add5~8_combout\))) # (!\data|s_money[2]~0_combout\ & (\data|Add6~10_combout\))
...
-- Equation(s):
-- \data|Add4~10_combout\ = \data|s_money\(6) $ (\data|Add4~9\)
...
-- Equation(s):
-- \data|Selector2~0_combout\ = (\data|s_money[2]~0_combout\ & ((\data|Add3~12_combout\))) # (!\data|s_money[2]~0_combout\ & (\data|Add4~10_combout\))
...
-- Equation(s):
-- \data|Selector2~2_combout\ = (\data|PS.S~q\ & ((\data|comb_proc~0_combout\ & (\data|Selector2~1_combout\)) # (!\data|comb_proc~0_combout\ & ((\data|Selector2~0_combout\)))))
...
PORT MAP (
	...
	datac => \data|Selector2~2_combout\,
	datad => \data|Selector31~3_combout\,
...
-- Equation(s):
-- \data|Selector24~0_combout\ = (!\data|PS.F_T~q\ & (((\data|s_money\(6)) # (!\data|LessThan1~10_combout\)) # (!\data|PS.S~q\)))
...
-- Equation(s):
-- \data|Selector38~0_combout\ = (\data|PS.I~q\ & (((\data|LessThan1~10_combout\ & !\data|s_money\(6))) # (!\data|PS.S~q\)))
...
-- Equation(s):
-- \data|Selector38~1_combout\ = (\data|Selector38~0_combout\ & ((\data|s_count_switches\(0)) # ((!\data|PS.F_N~q\) # (!\data|Equal0~0_combout\))))
...
PORT MAP (
	dataa => \data|s_count_switches\(0),
	datab => \data|Equal0~0_combout\,
	datac => \data|Selector38~0_combout\,
	datad => \data|PS.F_N~q\,
...
-- Equation(s):
-- \data|Selector35~0_combout\ = (\data|Selector15~0_combout\) # ((\data|LessThan1~10_combout\ & (\data|PS.S~q\ & !\data|s_money\(6))))
...
PORT MAP (
	...
	datab => \data|LessThan1~10_combout\,
	datac => \data|PS.S~q\,
	datad => \data|s_money\(6),
...
PORT MAP (
	...
	datac => \data|Selector13~0_combout\,
...
PORT MAP (
	...
	datac => \data|Selector9~0_combout\,
	datad => \data|Selector15~1clkctrl_outclk\,
...
-- pragma translate_on
PORT MAP (
	dataa => \data|Selector10~0_combout\,
...
-- Equation(s):
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[1]~0_combout\ = (((\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~34_combout\) # (\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~36_combout\)))
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[1]~1\ = CARRY((\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~34_combout\) # (\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~36_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~34_combout\,
	datab => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~36_combout\,
	datad => VCC,
...
-- Equation(s):
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[2]~2_combout\ = (\bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[1]~1\ & (((\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~34_combout\) # 
-- (\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[41]~35_combout\)))) # (!\bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[1]~1\ & (!\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~34_combout\ & 
-- (!\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[41]~35_combout\)))
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[2]~3\ = CARRY((!\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~34_combout\ & (!\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[41]~35_combout\ & 
...
PORT MAP (
	dataa => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[40]~34_combout\,
	datab => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[41]~35_combout\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	datab => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[44]~29_combout\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	dataa => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[45]~28_combout\,
	datad => VCC,
...
-- Equation(s):
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[52]~41_combout\ = (!\bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[7]~12_combout\ & \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[4]~6_combout\)
...
-- Equation(s):
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[51]~42_combout\ = (!\bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[7]~12_combout\ & \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[3]~4_combout\)
...
-- Equation(s):
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[49]~44_combout\ = (\bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_6_result_int[7]~12_combout\ & \data|s_hex01\(2))
...
-- Equation(s):
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_7_result_int[4]~7_cout\ = CARRY((!\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[51]~42_combout\ & (!\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[51]~52_combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[51]~42_combout\,
	datab => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[51]~52_combout\,
	datad => VCC,
...
-- Equation(s):
-- \bin2BCD_01|Mod0|auto_generated|divider|divider|add_sub_7_result_int[5]~9_cout\ = CARRY((\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[52]~41_combout\) # ((\bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[52]~51_combout\) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[52]~41_combout\,
	datab => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[52]~51_combout\,
	datad => VCC,
...
PORT MAP (
	...
	datab => \bin2BCD_01|Mod0|auto_generated|divider|divider|StageOut[49]~44_combout\,
...
-- Equation(s):
-- \data|Selector8~0_combout\ = (\data|s_price\(0) & (((\data|LessThan1~10_combout\ & !\data|s_money\(6))) # (!\data|PS.S~q\)))
...
-- Equation(s):
-- \bin2BCD_01|Div0|auto_generated|divider|divider|StageOut[26]~20_combout\ = (\data|s_hex01\(2) & \bin2BCD_01|Div0|auto_generated|divider|divider|add_sub_5_result_int[5]~8_combout\)
...
-- Equation(s):
-- \bin2BCD_01|Div0|auto_generated|divider|divider|StageOut[25]~22_combout\ = (\data|s_hex01\(2) & !\bin2BCD_01|Div0|auto_generated|divider|divider|add_sub_5_result_int[5]~8_combout\)
...
-- Equation(s):
-- \bin2BCD_01|Div0|auto_generated|divider|divider|StageOut[33]~23_combout\ = (\bin2BCD_01|Div0|auto_generated|divider|divider|add_sub_6_result_int[3]~4_combout\ & !\bin2BCD_01|Div0|auto_generated|divider|divider|add_sub_6_result_int[5]~8_combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \bin2BCD_01|Div0|auto_generated|divider|divider|add_sub_6_result_int[3]~4_combout\,
...
-- Equation(s):
-- \bin2BCD_01|Div0|auto_generated|divider|divider|add_sub_7_result_int[3]~5_cout\ = CARRY((!\bin2BCD_01|Div0|auto_generated|divider|divider|add_sub_7_result_int[2]~3_cout\ & ((\bin2BCD_01|Div0|auto_generated|divider|divider|StageOut[32]~24_combout\) # 
-- (\bin2BCD_01|Div0|auto_generated|divider|divider|StageOut[32]~30_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \bin2BCD_01|Div0|auto_generated|divider|divider|StageOut[32]~24_combout\,
	datab => \bin2BCD_01|Div0|auto_generated|divider|divider|StageOut[32]~30_combout\,
	datad => VCC,
